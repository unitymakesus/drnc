...
(function ($) {
  ...
  window.AblePlayer = function(media) {
    ...
    // Unity added unlisted property to turn off YT Captions for unlisted videos
    if ($(media).data('unlisted-fix') !== undefined && $(media).data('unlisted-fix') !== "") {
      this.unlistedFix = $(media).data('unlisted-fix');
    }
...
(function ($) {
  ...
  AblePlayer.prototype.setupYouTubeCaptions = function () {
    ...
    .done(function(){
      // Unity added this as a temporary workaround
      // Unlisted YouTube videos return 404 for captions and prevent whole player from loading
      // Issue #293: https://github.com/ableplayer/ableplayer/issues/293
      if (thisObj.unlistedFix == true) {
        deferred.resolve();
      } else {
