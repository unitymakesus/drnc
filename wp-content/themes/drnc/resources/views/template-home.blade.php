    ...
    <section class="background-purple background-point-left" role="region" aria-label="Overview">
        <div class="row">
          ...
          <div class="col m4 s12">
            ...
            <div>{{ get_field('cta_excerpt') }}</div>
            <div><a href="{{ get_field('cta_button_link') }}" class="btn">{{ get_field('cta_button_text') }}</a></div>
          </div>
        </div>
      </div>
    </section>

    <section class="background-white sa-tools" role="region" aria-labelled-by="sa-tools-title">
      <div class="container">
        <div class="row">
